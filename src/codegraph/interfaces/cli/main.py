...
from codegraph.core.risk import get_file_risk_scores, get_function_risk_scores
from codegraph.core.similarity import find_similar_functions
from codegraph.storage.loader import index_directory
from codegraph.storage.neo4j_client import get_driver
from codegraph.storage.queries import class_hierarchy, file_impact, function_impact, stats
...
def cmd_watch(args: argparse.Namespace) -> None:
    from codegraph.storage.watcher import watch_directory
...
def cmd_serve(args: argparse.Namespace) -> None:
    ...
    uvicorn.run(
        "codegraph.interfaces.web.app:app",
        host=args.host,
        port=args.port,
        reload=False,
    )
...
def cmd_mcp(args: argparse.Namespace) -> None:
    from codegraph.interfaces.mcp.server import run_mcp_server
...
def build_parser() -> argparse.ArgumentParser:
    ...
    index_parser.add_argument("path", nargs="?", default="examples")
    ...
    watch_parser.add_argument("path", nargs="?", default="examples")
